...
app.get("/dashboard", async (c) => {
  ...
  const { results: backlogData } = await db.prepare(`
    ...
    FROM dates d
  `).all();
  const deadlineStats = [{ name: "No Prazo", value: 87 }, { name: "Atrasado", value: 13 }];
  const initiationStats = [{ name: "Cumprida", value: 94 }, { name: "N\xE3o Cumprida", value: 6 }];
  ...
  const timeDistribution = [
    ...
    { name: "Ter\xE7a", value: 55 },
    { name: "Quarta", value: 49 },
    { name: "Quinta", value: 65 },
    { name: "Sexta", value: 38 },
    { name: "S\xE1bado", value: 10 },
...
// ../.wrangler/tmp/pages-OW1nqW/functionsRoutes-0.12377419089668618.mjs
var routes = [
  {
    routePath: "/api/:route*",
    mountPath: "/api",
