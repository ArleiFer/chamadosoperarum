...
app.post("/tickets", async (c) => {
  try {
    ...
    if (errorMessage.includes("UNIQUE") || errorMessage.includes("external_id") || errorMessage.includes("id")) {
      return c.json({ error: `Este chamado j\xE1 foi registrado anteriormente (OS duplicada). Erro t\xE9cnico: ${errorMessage}` }, 409);
    }
...
// ../.wrangler/tmp/pages-zo3mSR/functionsRoutes-0.9907082922248405.mjs
var routes = [
  {
    routePath: "/api/:route*",
    mountPath: "/api",
