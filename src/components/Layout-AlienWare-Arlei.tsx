...
export default function Layout({ children, currentView, onNavigate, onSelectTicket }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-outfit">
      ...
      <nav className="bg-operarum text-white border-b border-white/5 shadow-2xl sticky top-0 print:hidden z-50">
        <div className="w-full px-6 sm:px-8 lg:px-10">
          <div className="flex justify-between h-20">
            <div className="flex items-center py-4">
              <button 
                onClick={() => setIsSidebarOpen(!isSidebarOpen)}
                className="mr-4 p-2 md:hidden text-white hover:bg-white/10 rounded-lg transition-colors"
