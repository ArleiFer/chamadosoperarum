    ...
    try {
      const res = await fetch('/api/tickets', {
        ...
        body: JSON.stringify({
          ...
          photos: photos,
          // Only send specific IDs for SEEDF flow, otherwise keep them null to avoid duplicate errors
          external_id: flow === 'seedf' ? (formData.external_id || null) : null,
          id: flow === 'seedf' ? (formData.external_id || undefined) : undefined,
        }),
      });
